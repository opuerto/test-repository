...
const pnpmfileShim = {
    hooks: {
        ...
        afterAllResolved: (lockfile, context) => {
            ...
            return ((_a = userPnpmfile === null || userPnpmfile === void 0 ? void 0 : userPnpmfile.hooks) === null || _a === void 0 ? void 0 : _a.afterAllResolved) ? userPnpmfile.hooks.afterAllResolved(lockfile, context)
                : lockfile;
        },
